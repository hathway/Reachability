...
#import "HWAYReachability.h"

@interface TMViewController ()

-(void)reachabilityChanged:(NSNotification*)note;

@property(strong) HWAYReachability * googleReach;
@property(strong) HWAYReachability * localWiFiReach;
@property(strong) HWAYReachability * internetConnectionReach;
...
- (void)viewDidLoad
{
    ...
    self.googleReach = [HWAYReachability reachabilityWithHostname:@"www.google.com"];
    
    self.googleReach.reachableBlock = ^(HWAYReachability * reachability)
    {
    ...
    self.googleReach.unreachableBlock = ^(HWAYReachability * reachability)
    {
    ...
    self.localWiFiReach = [HWAYReachability reachabilityForLocalWiFi];

    // we ONLY want to be reachable on WIFI - cellular is NOT an acceptable connectivity
    self.localWiFiReach.reachableOnWWAN = NO;

    self.localWiFiReach.reachableBlock = ^(HWAYReachability * reachability)
    {
    ...
    self.localWiFiReach.unreachableBlock = ^(HWAYReachability * reachability)
    {
    ...
    self.internetConnectionReach = [HWAYReachability reachabilityForInternetConnection];

    self.internetConnectionReach.reachableBlock = ^(HWAYReachability * reachability)
    {
    ...
    self.internetConnectionReach.unreachableBlock = ^(HWAYReachability * reachability)
    {
...
-(void)reachabilityChanged:(NSNotification*)note
{
    HWAYReachability * reach = [note object];
